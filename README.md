...
- [ ] Randomized: Quick Sort (Randomized Pivot)
- [ ] Randomized: Monte Carlo Algorithms (e.g., Primality Testing)
- [ ] Approximation: Traveling Salesman Problem (TSP) Approximation
- [ ] Hashing: Consistent Hashing
- [ ] Compression: Run-Length Encoding (RLE)
- [ ] Encryption: Basic Caesar Cipher (for learning)
...
- [ ] Architectural: Model-View-ViewModel (MVVM)
- [ ] Architectural: Layered Architecture
- [ ] Other: Dependency Injection
- [ ] Other: Repository Pattern
