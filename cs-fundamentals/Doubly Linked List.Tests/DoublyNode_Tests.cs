...
{
    public class DoublyNode_Tests
    {
        [Fact]
        public void Constructor_WithValue_SetsValueCorrectly()
        {
            // Arrange & Act
            var node = new DoublyNode<int>(42);
        ...
        {
            // Arrange & Act
            var node = new DoublyNode<string>("test");
        ...
        {
            // Arrange
            var node = new DoublyNode<int>(10);
        ...
        [Fact]
        public void Previous_Property_InitiallyNull()
        {
            // Arrange & Act
            var node = new DoublyNode<int>(1);
        ...
        [Fact]
        public void Previous_Property_CanBeSet()
        {
            // Arrange
            ...
            Assert.Equal(1, node2.Previous.Value);
        }
        ...
        public void Node_CanFormLinkedList()
        {
            ...
            var node1 = new DoublyNode<int>(1);
            var node2 = new DoublyNode<int>(2);
            var node3 = new DoublyNode<int>(3);
            ...
            // Assert - проверяем связи назад
            Assert.Null(node1.Previous);
            Assert.Equal(node1, node2.Previous);
            Assert.Equal(node2, node3.Previous);
        ...
        {
            // Arrange & Act
            var node = new DoublyNode<string?>(null);
        ...
        {
            // Arrange
            var node = new DoublyNode<string?>("not null");
        ...
        {
            // Arrange & Act
            var node = new DoublyNode<int>(value);
        ...
        {
            // Arrange
            var nodes = new List<DoublyNode<int>>
            {
                new DoublyNode<int>(1),
                new DoublyNode<int>(2),
                new DoublyNode<int>(3)
            };
        ...
        public void Previous_And_Next_CanBeCircular()
        {
            ...
            node1.Previous = node2; // циклическая ссылка

            // Assert
            Assert.Equal(node2, node1.Next);
            Assert.Equal(node2, node1.Previous);
        ...
        public void Node_WithComplexObject_WorksCorrectly()
        {
            ...
            // Act
            var node = new DoublyNode<ComplexObject>(complexObject);
        ...
        public void Node_Properties_AreIndependent()
        {
            // Arrange
            var node = new DoublyNode<int>(1);
            var prevNode = new DoublyNode<int>(0);
            var nextNode = new DoublyNode<int>(2);
            ...
            Assert.Equal(prevNode, node.Previous);
