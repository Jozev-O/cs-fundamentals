...
namespace Circular_Linked_List
{
    public class Circular_Linked_List<T>
    {
        ...
        public Circular_Node<T>? GetHeadForTesting() => _head;
        public Circular_Node<T>? GetTailForTesting() => _tail;
        public void SetHeadForTesting(Circular_Node<T>? node) => _head = node;
        public void SetTailForTesting(Circular_Node<T>? node) => _tail = node;
        #endregion
